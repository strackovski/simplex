 ...
 */
class ServiceSettingsType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('emailAddress', 'text', array('required' => false, 'mapped' => false))
            ...
            ->add('privateKey', 'file', array('required' => false, 'mapped' => false))
            ->add('save', 'submit', array(
                'attr' => array('class' => 'btn-save')
            ))
            ->add('cancel', 'button', array(
                'attr' => array('class' => 'btn-cmd cmd-cancel btn-cancel')
            ));
    }
